...
async def lifespan(app:FastAPI):
    logger.info("Pinterest Autonomous Agent v3.7.0 starting... quality_patch=%s", QUALITY_PATCH_VERSION); logger.info("Quota governor: %s",quota.snapshot()); logger.info("Amazon layer credentials_present=%s mode=%s",amazon_credentials_present(),SCHEDULER_MODE)
